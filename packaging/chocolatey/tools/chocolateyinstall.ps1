...
Write-Host "Want the Realms/telemetry/profanity extras? Those need config.json, written by the full"
Write-Host "installer instead of this package:"
Write-Host "  irm https://github.com/Sm0keSkreen/mcrl/releases/latest/download/install.bat -outfile install.bat; .\install.bat"
